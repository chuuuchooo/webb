...
@section('title', 'User Management & Activity Log')

@section('content')
<div class="container-fluid">
    <!-- Combined User Management & Activity Log Table -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Health Workers: Management & Activity</h6>
        </div>
        <div class="card-body">
